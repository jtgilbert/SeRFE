...
dist_start = [0]  # time step to begin disturbance. This can be a single value if it is the same for all disturbances,
                  # or a list of the same length as segment IDs, where each value is the start time step for that
                  # specific segment.
dist_end = [0]  # time step to end disturbance. This can be a single value if it is the same for all disturbances,
                # or a list of the same length as segment IDs, where each value is the end time step for that specific
                # segment.
new_denude = [[0, 0]] # gamma shape and scale values for new denudation/erosion rates from disturbance. Can be single
